    ...
    class Build : NukeBuild
    {
        ...
        .Executes(() =>
        {
            ...
            foreach (var project in BuildInformation.Projects.OrderBy(o => o.BuildOrder))
            {
                ...
                ProcessTasks.StartProcess(Powershell, buildDir + "/" + project.BuildCmd + " -StudioVersion "+BuildVersion, buildDir).AssertWaitForExit();
        ...
        .Executes(() =>
        {
            ...
            if (PushContainerImage.ToString().ToLower() == "true")
            {
        ...
        public void BuildAndPushContainerImage(string buildVersion)
        {
